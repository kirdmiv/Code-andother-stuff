...
fin = open("lines2.in", 'r')
fout = open("lines2.out", 'w')

A1, B1, C1 = map(int, fin.readline().split())
A2, B2, C2 = map(int, fin.readline().split())

print(B1, -A1, file=fout)
print(B2, -A2, file=fout)
...
if d == 0 and d1 == 0 and d2 == 0:
    ...
    print(abs(C1 - C2) / slon, file=fout)
fin.close()
fout.close()
